...
export const INVITE_ONLY_GUEST_ENABLED: boolean = env.INVITE_ONLY_GUEST_ENABLED;
export const GUEST_ACCESS_TOKEN_TTL_HOURS: number = env.GUEST_ACCESS_TOKEN_TTL_HOURS;
...
export const AI_NOTETAKER_API_URL: string | undefined = env.AI_NOTETAKER_API_URL;
...
export const FRONT_ENVIRONMENT_VARIABLES: FrontConfigurationInterface = {
    ...
    ENABLE_CHAT_UPLOAD,
    AI_NOTETAKER_ENABLED: env.AI_NOTETAKER_ENABLED,
    FALLBACK_LOCALE,
    ...
    VOICE_INDICATOR_PERF_ENABLED: env.VOICE_INDICATOR_PERF_ENABLED,
    VOICE_INDICATOR_DISABLE_TWEEN: env.VOICE_INDICATOR_DISABLE_TWEEN,
    VOICE_INDICATOR_USE_HYSTERESIS: env.VOICE_INDICATOR_USE_HYSTERESIS,
    VOICE_INDICATOR_ON_THRESHOLD: env.VOICE_INDICATOR_ON_THRESHOLD,
    VOICE_INDICATOR_OFF_THRESHOLD: env.VOICE_INDICATOR_OFF_THRESHOLD,
    VOICE_INDICATOR_MIN_ON_MS: env.VOICE_INDICATOR_MIN_ON_MS,
    VOICE_INDICATOR_MIN_OFF_MS: env.VOICE_INDICATOR_MIN_OFF_MS,
    VOICE_INDICATOR_DEBUG_LOGS: env.VOICE_INDICATOR_DEBUG_LOGS,
