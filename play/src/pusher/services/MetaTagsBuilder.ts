...
export const MetaTagsDefaultValue: RequiredMetaTagsData = {
    title: "Darna",
    description:
        "Organize your online event in Darna to recreate spontaneous social interactions. Connect, collaborate and have fun with your teammates and attendees.",
    author: "DarBlockchain team",
    provider: "DarBlockchain",
    favIcons: [
        {
            rel: "icon",
            sizes: "512x512",
            src: "/static/images/favicons/favicon-144x144.svg",
        },
    ],
    manifestIcons: [
        {
