...
export const AI_NOTETAKER_ENABLED = env.AI_NOTETAKER_ENABLED;
...
export const ZOOM_DISCRETE_LEVEL_COUNT = env.ZOOM_DISCRETE_LEVEL_COUNT ?? 32;
export const ZOOM_WHEEL_STEP = env.ZOOM_WHEEL_STEP ?? 20;
export const ZOOM_MAX_STEPS_PER_EVENT = env.ZOOM_MAX_STEPS_PER_EVENT ?? 8;
export const ENABLE_DOM_PLAYER_NAMES = env.ENABLE_DOM_PLAYER_NAMES ?? false;
export const VOICE_INDICATOR_PERF_ENABLED = env.VOICE_INDICATOR_PERF_ENABLED ?? false;
export const VOICE_INDICATOR_DISABLE_TWEEN = env.VOICE_INDICATOR_DISABLE_TWEEN ?? false;
export const VOICE_INDICATOR_USE_HYSTERESIS = env.VOICE_INDICATOR_USE_HYSTERESIS ?? true;
export const VOICE_INDICATOR_ON_THRESHOLD = env.VOICE_INDICATOR_ON_THRESHOLD ?? 12;
export const VOICE_INDICATOR_OFF_THRESHOLD = env.VOICE_INDICATOR_OFF_THRESHOLD ?? 8;
export const VOICE_INDICATOR_MIN_ON_MS = env.VOICE_INDICATOR_MIN_ON_MS ?? 400;
export const VOICE_INDICATOR_MIN_OFF_MS = env.VOICE_INDICATOR_MIN_OFF_MS ?? 250;
export const VOICE_INDICATOR_DEBUG_LOGS = env.VOICE_INDICATOR_DEBUG_LOGS ?? false;
